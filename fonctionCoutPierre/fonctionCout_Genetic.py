...
def main(simulated_signal_folder, real_signal_folder):
    sigArray1 = getData(simulated_signal_folder)
    sigArray2 = getData(real_signal_folder)
    cost = cout(sigArray1, sigArray2)
    return cost